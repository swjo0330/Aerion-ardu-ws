...
| 환경 | 내 IP / NIC | 저쪽 IP | 매체 | RTT | 저쪽 **처리율 FPS** | 카메라 전달률(≈소스) |
|---|---|---|---|---|---|---|
| **집 (Wi-Fi)** | 192.168.45.50 / en0 | 192.168.45.93 | 무선 양단 | — | **60~80** | 18~25 (gz ~22Hz) |
| **사무실/랩 (유선)** | 10.130.200.31 / **en7** | 10.130.200.36 | 유선 | **0.8ms** | **130~150** | ≈ gz 렌더 ~14~22Hz |
